# LopoLabCalc — Backlog & histórico de decisões

> Detalhe do backlog: prioridades, decisões de design (D1–D8), auditoria (TD-*),
> features (FEAT-*), bugs e ordem de execução. **Não** é carregado a cada conversa —
> o Claude lê este arquivo **sob demanda**, ao pegar um item. O `CLAUDE.md` guarda só a
> foto do AGORA + diretrizes (ver Diretriz 8). Referências a "item 3", "FEAT-04", etc.
> resolvem dentro deste arquivo.
