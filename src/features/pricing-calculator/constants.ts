...
// PTFE, lubrificação). Estimado no cenário "importado/genérico" (AliExpress, ML,
// Shopee), que é ~metade do preço de loja BR especializada. Bico genérico ~R$80,
// placa PEI 257mm genérica ~R$160-180, filtro carvão (X2D) ~R$70/1440h, vida útil
// típica. A1 (aberta, 1 bico) ~R$0,25/h; X2D (fechada, 2 bicos + filtros) ~R$0,45/h.
...
export const DEFAULT_MACHINES: Machine[] = [
  { id: "a1", name: "A1 Combo", price: 5299, lifeHours: 5000, watts: 95, maintenancePerHour: 0.25 },
  { id: "x2d", name: "X2D Combo", price: 13999, lifeHours: 5000, watts: 150, maintenancePerHour: 0.45 },
];
